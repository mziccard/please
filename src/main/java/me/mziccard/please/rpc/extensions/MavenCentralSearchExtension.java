...
public class MavenCentralSearchExtension implements SearchExtension {

  private RepositoryService repositoryService;

  /**
   * A {@code SearchUrlBuilder} object for Maven Central repository.
   */
  private final SearchUrlBuilder searchUrlBuilder;

  /**
   * A {@code SearchResponseParser} object for Maven Central repository.
   */
  private final SearchResponseParser searchResponseParser;

  public MavenCentralSearchExtension() {
    ...
    searchResponseParser = new MavenCentralSearchResponseParser();
  }
